...
#define APBDEV_PMC_TZRAM_PWR_CNTRL_0 MAKE_PMC_REG(0xbe8)
#define APBDEV_PMC_TZRAM_SEC_DISABLE_0 MAKE_PMC_REG(0xbec)
#define APBDEV_PMC_TZRAM_NON_SEC_DISABLE_0 MAKE_PMC_REG(0xbf0)

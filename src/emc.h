...
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_IGNORE_START         (1 << 29)
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_DUAL_PASS_LOCK       (1 << 28)
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_STEP_SIZE_SHIFT      24
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_STEP_SIZE_MASK       \
    (0xf << EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_STEP_SIZE_SHIFT)
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_END_COUNT_SHIFT      20
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_END_COUNT_MASK       \
    (0xf << EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_END_COUNT_SHIFT)
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_FILTER_BITS_SHIFT        16
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_FILTER_BITS_MASK     \
    (0xf << EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_FILTER_BITS_SHIFT)
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_SAMPLE_COUNT_SHIFT       12
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_SAMPLE_COUNT_MASK        \
    (0xf << EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_SAMPLE_COUNT_SHIFT)
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_SAMPLE_DELAY_SHIFT       4
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_SAMPLE_DELAY_MASK        \
    (0xff << EMC_PMACRO_DLL_CFG_0_DDLLCAL_CTRL_SAMPLE_DELAY_SHIFT)
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_UPDATE_CNT_LIMIT_SHIFT        0
#define EMC_PMACRO_DLL_CFG_0_DDLLCAL_UPDATE_CNT_LIMIT_MASK     \
    (0xf << EMC_PMACRO_DLL_CFG_0_DDLLCAL_UPDATE_CNT_LIMIT_SHIFT)

#define EMC_PMACRO_DLL_CFG_1                       0x5e8
#define EMC_PMACRO_DLL_CFG_1_DDLLCAL_CTRL_START_TRIM_SHIFT     10
#define EMC_PMACRO_DLL_CFG_1_DDLLCAL_CTRL_START_TRIM_MASK      \
    (0x7ff << EMC_PMACRO_DLL_CFG_1_DDLLCAL_CTRL_START_TRIM_SHIFT)

...
typedef enum {
    TEGRA_GPIO_PORT_A  =  0, // 0.0
    TEGRA_GPIO_PORT_B  =  1, // 0.1
    TEGRA_GPIO_PORT_C  =  2, // 0.2
    TEGRA_GPIO_PORT_D  =  3, // 0.3

    TEGRA_GPIO_PORT_E  =  4, // 1.0
    TEGRA_GPIO_PORT_F  =  5, // 1.1
    TEGRA_GPIO_PORT_G  =  6, // 1.2
    TEGRA_GPIO_PORT_H  =  7, // 1.3

    TEGRA_GPIO_PORT_I  =  8, // 2.0
    TEGRA_GPIO_PORT_J  =  9, // 2.1
    TEGRA_GPIO_PORT_K  = 10, // 2.2
    TEGRA_GPIO_PORT_L  = 11, // 2.3

    TEGRA_GPIO_PORT_M  = 12, // 3.0 
    TEGRA_GPIO_PORT_N  = 13, // 3.1
    TEGRA_GPIO_PORT_O  = 14, // 3.2
    TEGRA_GPIO_PORT_P  = 15, // 3.3

    TEGRA_GPIO_PORT_Q  = 16, // 4.0
    TEGRA_GPIO_PORT_R  = 17, // 4.1
    TEGRA_GPIO_PORT_S  = 18, // 4.2
    TEGRA_GPIO_PORT_T  = 19, // 4.3

    TEGRA_GPIO_PORT_U  = 20, // 5.0
    TEGRA_GPIO_PORT_V  = 21, // 5.1
    TEGRA_GPIO_PORT_W  = 22, // 5.2
    TEGRA_GPIO_PORT_X  = 23, // 5.3

    TEGRA_GPIO_PORT_Y  = 24, // 6.0
    TEGRA_GPIO_PORT_Z  = 25, // 6.1
    TEGRA_GPIO_PORT_AA = 26, // 6.2
    TEGRA_GPIO_PORT_BB = 27, // 6.3

    TEGRA_GPIO_PORT_CC = 28, // 7.0
    TEGRA_GPIO_PORT_DD = 29, // 7.1
    TEGRA_GPIO_PORT_EE = 30, // 7.2
    TEGRA_GPIO_PORT_FF = 31, // 7.3
} tegra_gpio_port;
